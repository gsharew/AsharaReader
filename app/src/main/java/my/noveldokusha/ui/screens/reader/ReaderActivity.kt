...
class ReaderActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.readerSpeaker.scrollToReaderItem.asLiveData().observe(this) { readerItem ->
            if (readerItem !is ReaderItem.Position) return@observe
            scrollToReadingPositionForced(
                chapterIndex = readerItem.chapterIndex,
                chapterItemPosition = readerItem.chapterItemPosition,
            )
        }

        viewModel.readerSpeaker.scrollToChapterTop.asLiveData().observe(this) { chapterIndex ->
                scrollToReadingPositionForced(
